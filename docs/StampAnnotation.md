...
**Icon** | [***StampIcon**](StampIcon.md) | Gets or sets icon for rubber stamp. | [optional] [default to null]
**FilePath** | **string** | Sets content file path.  | [optional] [default to null]
**HasImage** | **bool** | Gets is image exist.  | [optional] [default to null]

[[Back to Model list]](../README.md#documentation-for-models) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to README]](../README.md)[[View Source]](../stamp_annotation.go)
