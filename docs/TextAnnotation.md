...
**State** | [***AnnotationState**](AnnotationState.md) | Gets or sets the state to which the original annotation should be set. | [optional] [default to null]
**Open** | **bool** | Gets or sets is the annotation open. | [optional] [default to null]
