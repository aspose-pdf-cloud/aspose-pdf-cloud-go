...
**Icon** | [***FileIcon**](FileIcon.md) | Gets or sets icon that shall be used in displaying annotation. | [optional] [default to null]
**Opacity** | **float64** | Gets or sets icon&#39;s opacity from 0 to 1: 0 - completely transparant, 1 - completely opaque. | [optional] [default to null]
**FileDescription** | **string** | Gets or sets text associated with the file specification.  | [optional] [default to null]
**FileName** | **string** | Gets or sets file specification name.  | [optional] [default to null]
**FilePath** | **string** | Sets content file path.  | [optional] [default to null]

[[Back to Model list]](../README.md#documentation-for-models) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to README]](../README.md)[[View Source]](../file_attachment_annotation.go)
