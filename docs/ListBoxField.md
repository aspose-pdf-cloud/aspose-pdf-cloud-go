...
**Options** | [**[]Option**](Option.md) | Gets collection of options of the listbox. | [optional] [default to null]
**ActiveState** | **string** | Gets or sets current annotation appearance state. | [optional] [default to null]
**TopIndex** | **int32** | Gets or sets index of the top visible element of the list. | [optional] [default to null]
**SelectedItems** | **[]int32** | Gets or sets array of the selected items in the multiselect list. For single-select list returns array with single item. | [optional] [default to null]

[[Back to Model list]](../README.md#documentation-for-models) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to README]](../README.md)[[View Source]](../list_box_field.go)
