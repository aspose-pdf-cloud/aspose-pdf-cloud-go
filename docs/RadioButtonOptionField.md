...
**OptionName** | **string** | Gets or sets name of the option. | [optional] [default to null]
**Style** | [***BoxStyle**](BoxStyle.md) | Style of field box. | [optional] [default to null]

[[Back to Model list]](../README.md#documentation-for-models) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to README]](../README.md)[[View Source]](../radio_button_option_field.go)
