...
func appendStrikeoutAnnotation(pdf_api *asposepdfcloud.PdfApiService, document string, output_document string, page_num int32, text string, subject string, contents string, description string, rect *asposepdfcloud.Rectangle, remote_folder string) {
	...
	result, httpResponse, err := pdf_api.PostPageStrikeOutAnnotations(
		document, page_num, []asposepdfcloud.StrikeOutAnnotation{new_annotation}, args,
	)
	if err != nil {
